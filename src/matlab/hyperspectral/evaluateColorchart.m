function [T, measuredSpectra, adjustedSpectra] = evaluateColorchart(filename, experiment, allowRoiSelection, selectedPatches, option)
...
%   experiment, allowRoiSelection, selectedPatches) returns values for
%   evaluation of the colorchart
%
%   Input parameters 
%   -filename: HSI file to read 
%   -experiment: Name of current experiment
