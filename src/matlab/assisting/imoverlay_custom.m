function [] = imoverlay_custom(B,F,climF,cmap,alpha,haxes)
...
c = colorbar('location','southoutside', 'Ticks', [0 0.5 1], 'TickLabels', {'low', 'medium', 'high'}, 'AxisLocation','in');
