...
if contains(filename, 'only_spect')
    ...
    plots(fig, @plotClassificationPerformanceBars, barAccInfo1, lbpsShow, {'SVM', 'KNN', 'RF'}, 'ROC AUC', [50, 100], 1);
    ...
    plots(fig, @plotClassificationPerformanceBars, barDORInfo1./100, lbpsShow, {'SVM', 'KNN', 'RF'}, 'DOR', [0, 30], 1);
    ...
    plots(fig, @plotClassificationPerformanceBars, barAccInfo1, lbpsShow, {'SVM', 'KNN', 'RF'}, 'ROC AUC', [50, 100], 2);

    setSetting('plotName', fullfile(getSetting('savedir'), 'mixed_classifier_dor'));
    barDORInfo1 = getRespectiveValues(barAccInfo1, idxs, tab.DOR);
    plots(fig, @plotClassificationPerformanceBars, barDORInfo1./100, lbpsShow, {'SVM', 'KNN', 'RF'}, 'DOR', [0, 30], 2);
    ...
    plots(fig, @plotClassificationPerformanceBars, barAccInfo2, lbpsShow, {'Unfixed', 'Fixed', 'Mixed'}, 'ROC AUC', [50, 100], 3);
    ...
    plots(fig, @plotClassificationPerformanceBars, barAccInfo2, lbpsShow, {'Unfixed', 'Fixed', 'Mixed'}, 'ROC AUC', [50, 100], 4);
    ...
    plots(fig, @plotClassificationPerformanceBars, barAccInfo2, lbpsShow, {'Unfixed', 'Fixed', 'Mixed'}, 'ROC AUC', [50, 100], 5);

    barDORInfo1 = getRespectiveValues(barAccInfo1, idx1, tab.DOR);
    setSetting('plotName', fullfile(getSetting('savedir'), 'knn_tissue_dor'));
    plots(fig, @plotClassificationPerformanceBars, barDORInfo1./100, lbps, {'Unfixed', 'Fixed', 'Mixed'}, 'DOR', [0, 30], 3);
    barDORInfo1 = getRespectiveValues(barAccInfo1, idx2, tab.DOR);
    setSetting('plotName', fullfile(getSetting('savedir'), 'svm_tissue_dor'));
    plots(fig, @plotClassificationPerformanceBars, barDORInfo1./100, lbps, {'Unfixed', 'Fixed', 'Mixed'}, 'DOR', [0, 30], 4);
    barDORInfo1 = getRespectiveValues(barAccInfo1, idx3, tab.DOR);
    setSetting('plotName', fullfile(getSetting('savedir'), 'rf_tissue_dor'));
    plots(fig, @plotClassificationPerformanceBars, barDORInfo1./100, lbps, {'Unfixed', 'Fixed', 'Mixed'}, 'DOR', [0, 30], 5);
