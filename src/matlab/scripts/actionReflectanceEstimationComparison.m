...
for i = 1:methodsN
    ...
    saveOptions.plotName = fullfile(saveOptions.savedir, getOutputDirectoryMap('reflectanceEstimationPerformance'), strcat('hist_', methods{i}));
...
filename = mkNewDir(fullfile(saveOptions.savedir, getOutputDirectoryMap('features'), 'out.mat'));
...
saveOptions.plotName = fullfile(saveOptions.savedir, getOutputDirectoryMap('reflectanceEstimationPerformance'), method);
