for k = [20, 19, 18]
    ...
    if k == 20
        ...
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'Svm_unfixed', options.saveOptions, 3, 'Unfixed');
        ...
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'Knn_unfixed', options.saveOptions, 1, 'Unfixed');
        ...
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'RF_unfixed', options.saveOptions, 2, 'Unfixed');

        trueLabels = [1, 1, 1, 1, 0, 0];
        plotVisualResultAfterClassification([0, 0, 0, 0, 0, 0], trueLabels, coordinates, orderedRois, segmentMasks, sRGB, 'GD_unfixed', options.saveOptions, 2, 'Fixed');
    ...
    elseif k == 19
        ...
        predictedLabels = [1, 1, 1, 1, 1, 1, 1, 1];
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'Svm_fixed', options.saveOptions, 3, 'Fixed');

        cancerProb = [1., 1., 1., 1., 1., 1., 0.32505164, 0.32528109];
        predictedLabels = [1, 1, 1, 1, 1, 1, 0, 0];
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'Knn_fixed', options.saveOptions, 1, 'Fixed');

        cancerProb = [0.56, 0.62, 0.57, 0.64, 0.58, 0.54, 0.58, 0.64];
        predictedLabels = [1, 1, 1, 1, 1, 1, 1, 1];
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'RF_fixed', options.saveOptions, 2, 'Fixed');

        trueLabels = [1, 1, 1, 1, 1, 1, 0, 0];
        plotVisualResultAfterClassification([0, 0, 0, 0, 0, 0, 0, 0], trueLabels, coordinates, orderedRois, segmentMasks, sRGB, 'GD_fixed', options.saveOptions, 2, 'Fixed');
    ...
    elseif k == 18
        ...
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'Svm_sectioned', options.saveOptions, 3, 'Sectioned');

        cancerProb = [0.69429197, 0.66705237, 0.39345565, 1., 0.31506872, 1., 0.34356235, 0.66886696];
        predictedLabels = [1, 1, 0, 1, 0, 1, 0, 1];
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'Knn_sectioned', options.saveOptions, 1, 'Sectioned');

        cancerProb = [0.52, 0.56, 0.52, 0.58, 0.61, 0.53, 0.51, 0.44];
        predictedLabels = [1, 1, 1, 1, 1, 1, 1, 0];
        plotVisualResultAfterClassification(cancerProb, predictedLabels, coordinates, orderedRois, segmentMasks, sRGB, 'RF_sectioned', options.saveOptions, 2, 'Sectioned');

        trueLabels = [1, 1, 1, 1, 1, 1, 0, 0];
        plotVisualResultAfterClassification([0, 0, 0, 0, 0, 0, 0, 0], trueLabels, coordinates, orderedRois, segmentMasks, sRGB, 'GD_sectioned', options.saveOptions, 2, 'Sectioned');
