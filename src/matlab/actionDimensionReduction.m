...
options.saveOptions.plotName = generateName(options, [dimredMethodCap , ' of ', input, ' spectra by type [by projection base of measured]']);
plots(dimredMethod, 7, Gun * WMeasured, [dimredMethodCap,' Fix'], 'LineNames', lineNamesun, 'SaveOptions', options.saveOptions);
options.saveOptions.plotName = generateName(options, [dimredMethodCap, ' of ', input, ' spectra by sample [by projection base of measured]']);
plots(dimredMethod, 8, Gun * WMeasured, [dimredMethodCap, ' Sample'], 'LineNames', lineNamesun, 'SaveOptions', options.saveOptions)

options.saveOptions.plotName = generateName(options, [dimredMethodCap, ' of ', input, ' spectra by sample (only unfixed) [by projection base of measured]']);
